...
class BridgeTopo(Topo):
    ...
    def __init__(self):
        ...
        e1 = self.addLink(h1,s1,bw=15,latency='10ms')
        e2 = self.addLink(h2,s1,bw=15,latency='10ms')
        e3 = self.addLink(h3,s2,bw=15,latency='10ms')
        e4 = self.addLink(h4,s2,bw=15,latency='10ms')
        e5 = self.addLink(s1,s2,bw=20,latency='45ms')
